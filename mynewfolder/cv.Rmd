...
params:
  ...
  title: 'Ying-Ju Chen, PhD'
  
  # contact me information
  name_for_google_scholar_link: 'Ying-Ju Chen'
  email: 'ychen4@udayton.edu'
  github: 'Ying-Ju'
  twitter: 'ju_tessa'
  
  # your google scholar id (e.g., https://scholar.google.com/citations?user=nfXnYKcAAAAJ)
  scholar_id: 'nfXnYKcAAAAJ' # my id is easily extracted from my Scholar Profile link above
  
  # my name appears as Ying-Ju Chen and Y.J. Chen in my publications
  # as shown here: https://scholar.google.com/citations?user=nfXnYKcAAAAJ&hl=en
  author_name: 'YJ Chen'
  ...
  graduate_student_names: !r c('Dolatsara,', 'Maman,', 'Ma,')
  ...
  # as shown below (make sure that the comma is included in the comments since I will parse based on it)
  undergrad_student_names: !r c('Evans, C.')
  ...
  invited_paper_titles: !r c('The Class Imbalance Problem') 
  ...
  memberships: !r c('American Statistical Association')
---
